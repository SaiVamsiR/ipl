...
with col1:
    ...
    st.markdown(f"<div style='text-align:center'>{batting_team}</div>", unsafe_allow_html=True)
...
with col2:
    ...
    st.markdown(f"<div style='text-align:center'>{bowling_team}</div>", unsafe_allow_html=True)
